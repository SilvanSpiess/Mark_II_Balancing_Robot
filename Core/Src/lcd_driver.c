/***************************************************************************************************
  ...
  * @version    V0.5
	...
	* @date       08.10.2019
  * @date       28.10.2015
  * @brief      // V0.5;dnd1;add;lcd_setRect() function
  * @brief      // V0.4;dnd1;add;lcd_setLine() function
  * @brief      Display setup and communication for LCD on mbed16-application-shield
  * @hardware   STM32F407 on 2D printer
  **************************************************************************************************
  * @attention
  *
  * <h2><center>&copy; COPYRIGHT 2019 BFH-TI </center></h2>
  *
  */
...
// V0.4;dnd1;add;setLine() function
